...
<query42>{
  let $m := map:map()
  let $build :=
    for $sales in doc()[c_region="AMERICA"]/lineorder[supplier/s_region="AMERICA" and (part/p_mfgr="MFGR#1" or part/p_mfgr="MFGR#2") and (orderdate/d_year=1997 or orderdate/d_year=1998)]
