...
<query43>{
  let $m := map:map()
  let $build :=
    for $sales in doc()[supplier/s_nation="UNITED STATES" and customer/c_region="AMERICA" and (orderdate/d_year=1997 or orderdate/d_year=1998) and part/p_category="MFGR#14"]
