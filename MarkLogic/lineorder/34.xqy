...
<query34>{
  let $m := map:map()
  let $build :=
    for $sales in doc()[(supplier/s_city="UNITED KI1" or supplier/s_city="UNITED KI5") and (customer/c_city="UNITED KI1" or customer/c_city="UNITED KI5") and orderdate/d_yearmonthnum=199712]
